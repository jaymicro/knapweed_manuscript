...
all_data
ggsave(all_data, filename = "plot/data_normalizedfig.jpg", height = 8, width = 10, units = "in", dpi = 600)
...
```{r}
jpeg("corr.plot.jpg", width = 2840, height = 2840, res = 300)
...
ggsave(plt_pca_loadings, filename = "plot/plt_pca_loadings.jpg", height = 8, width = 10, units = "in", dpi = 600)
```


## plot PCA with broken stick model
```{r}
jpeg("bstick.jpg", width = 2840, height = 1840, res =400)
...
ggsave(plt_all, filename = "plot/plt_all.jpg", height = 10, width = 10, units = "in", dpi = 800)
